    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authz -> authz
                                ...
                                .requestMatchers(HttpMethod.PATCH, "/usuario/**").hasAnyAuthority("ROLE_Chefe", "ROLE_Admin")
                                .requestMatchers(HttpMethod.POST,"/ocorrencias/**").hasAnyAuthority("ROLE_Chefe", "ROLE_Admin", "ROLE_Analista")
                                .requestMatchers(HttpMethod.DELETE,"/ocorrencias/**").hasAnyAuthority("ROLE_Chefe", "ROLE_Admin", "ROLE_Analista")
                                .requestMatchers(HttpMethod.PATCH,"/ocorrencias/**").hasAnyAuthority("ROLE_Chefe", "ROLE_Admin", "ROLE_Analista")
